							...
							<section class="main">
								...
								<div class="col-12">
									<ul class="actions" style="display:flex; justify-content:flex-end;">
										<li><input type="button" value="목록" class="primary" onclick="location.href='${pageContext.request.contextPath}/board/BoardList.ob'"/></li>
									</ul>
								</div>
								<form action="${pageContext.request.contextPath}/board/OwnerBoardModifyOk.ob" name="writeForm" method="post" enctype="multipart/form-data">
									<input type="hidden" name="board_num" value="${board.getBoard_num()}">
									<header class="major">
										<p>
											<input id="board_title" name="board_title" type="text" placeholder="제목 입력" value="${board.getBoard_title()}">
										</p>
										<p style="text-align:left; margin-bottom:1%; margin-top:-1.75em;">작성자 : ${board.getMart_name()}</p>
									</header>
									...
									<div style="margin-top:3%;">
										<textarea name="board_content" placeholder="내용 작성" style="resize:none;" rows="30">${board.getOwner_board_content()}</textarea>
									</div>
