				...
				<!-- Wrapper -->
					<div class="wrapper">
						<div class="inner">
							...
							<!-- Main -->
							<section class="main">
								<a href="#" class="image main"><img src="${pageContext.request.contextPath}/images/familydinner.jpg" alt="" /></a>
								<div class="col-12">
									<ul class="actions" style="display:flex; justify-content:flex-end;">
										<li><input type="button" value="목록" class="primary" onclick="location.href='${pageContext.request.contextPath}/board/UserBoardList.ub'"/></li>
									</ul>
								</div>
								<form action="${pageContext.request.contextPath}/board/UserBoardModifyOk.ub" name="writeForm" method="post" enctype="multipart/form-data">
									<input type="hidden" name="board_num" value="${board.getUser_board_num()}">
									<header class="major">
										<p>
											<input id="board_title" name="board_title" type="text" placeholder="제목 입력" value="${board.getUser_board_title()}">
										</p>
										<p style="text-align:left; margin-bottom:1%; margin-top:-1.75em;">작성자 : ${board.getUser_nickname()}</p>
									</header>
									...
									<div style="margin-top:3%;">
										<textarea name="board_content" placeholder="내용 작성" style="resize:none;" rows="30">${board.getUser_board_content()}</textarea>
									</div>
